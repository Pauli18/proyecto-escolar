                                            ...
                                            <table name="usuarios" id="usuarios" class="table table-striped" style="width:95%">
                                                        ...
                                                        <?php foreach($usuarios as $usuario) {?>
                                                            <tr>
                                                                ...
                                                                <td><center><button type="button" class="btn btn-md btn-danger" id="eliminau" nombre="eliminau" data-bs-toggle="modal" data-bs-target="#modaleliminaru<?php echo $usuario['id_usu'];?>"><i class="fa-solid fa-trash"></i></button></center></td>
                                                            </tr>
